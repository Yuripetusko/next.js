...
var Head = exports.Head = (function (_Component2) {
  ...
  (0, _createClass3.default)(Head, [{
    ...
    value: function getPreloadMainLinks () {
      ...
      if (dev) {
        return [this.getChunkPreloadLink('manifest.js'), this.getChunkPreloadLink('main.js')]
      }

      // In the production mode, we have a single asset with all the JS content.
      return [this.getChunkPreloadLink('main.js')]
    }
  }, {
...
var NextScript = exports.NextScript = (function (_Component4) {
  ...
  (0, _createClass3.default)(NextScript, [{
    ...
    value: function getScripts () {
      ...
      if (dev) {
        return [this.getChunkScript('manifest.js'), this.getChunkScript('main.js')]
      }
    ...
    value: function render () {
      ...
      return _react2.default.createElement(
        Fragment,
        null,
        staticMarkup ? null : _react2.default.createElement('script', { nonce: this.props.nonce,
